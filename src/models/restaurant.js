...
const restaurantSchema = new mongoose.Schema(
  {
    ...
    priceRange: { type: Number, default: 2, min: 1, max: 4, index: true },
    estimatedDeliveryTime: { type: Number, default: 30, min: 1, index: true },
    isVegOnly: { type: Boolean, default: false, index: true },
